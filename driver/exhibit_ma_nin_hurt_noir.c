...
static constexpr char DEFAULT_OUTPUT[] =
    "build/ma_nin_hurt_noir_180s.wav";
...
int main(int argc, char **argv) {
    ...
    printf("Mamut Analog — Hurt, noir synth reinterpretation\n");
    ...
    printf("  Raster: 18%% upper pad; Prizma: 30%% rhythmic tails, fixed morph\n");
